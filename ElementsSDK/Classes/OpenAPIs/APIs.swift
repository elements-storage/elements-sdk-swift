...
// We reverted the change of ElementsSDKAPI to ElementsSDK introduced in https://github.com/OpenAPITools/openapi-generator/pull/9624
...
@available(*, deprecated, renamed: "ElementsSDKAPI")
public typealias ElementsSDK = ElementsSDKAPI
...
open class RequestBuilder<T> {
    ...
    @discardableResult
    open func execute(_ apiResponseQueue: DispatchQueue = ElementsSDKAPI.apiResponseQueue, _ completion: @escaping (_ result: Swift.Result<Response<T>, ErrorResponse>) -> Void) -> RequestTask {
        return requestTask
    }
