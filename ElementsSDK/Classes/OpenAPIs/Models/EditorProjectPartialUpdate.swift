//
// EditorProjectPartialUpdate.swift
//
...
public struct EditorProjectPartialUpdate: Codable, JSONEncodable, Hashable {
    ...
    public init(file: Int? = nil, parent: Int? = nil, parentPath: String? = nil, existingFile: Int? = nil, format: String? = nil, project: AnyCodable? = nil) {
        self.file = file
        self.parent = parent
