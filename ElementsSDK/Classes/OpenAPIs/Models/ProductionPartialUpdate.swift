...
public struct ProductionPartialUpdate: Codable, Hashable {
    ...
    public init(name: String? = nil, obscureName: Bool? = nil, description: String? = nil, longDescription: String? = nil, active: Bool? = nil, template: Int? = nil, defaultGroup: Int? = nil) {
        self.name = name
