...
public struct ElementsGroup: Codable, Hashable {
    ...
    public init(id: Int? = nil, permissions: [String]? = nil, membersPreview: [MemberPreview]? = nil, effectivePermissions: [String]? = nil, name: String, ldapDn: String? = nil, unixGroupname: String? = nil, gid: Int? = nil, ancillaryPath: String? = nil, ancillaryPathReadOnly: Bool? = nil, ldap: Int? = nil, members: Set<Int>) {
        self.id = id
