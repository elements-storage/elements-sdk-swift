...
public struct ElementsGroup: Codable, JSONEncodable, Hashable {
    ...
    public init(id: Int, permissions: [String]? = nil, membersPreview: [MemberPreview], effectivePermissions: [String], ancillaryPath: String? = nil, ancillaryPathReadOnly: String? = nil, name: String, ldapDn: String? = nil, unixGroupname: String? = nil, gid: Int? = nil, ldap: Int? = nil, members: [Int]) {
        self.id = id
