...
public struct MediaRootDetail: Codable, JSONEncodable, Hashable {
    ...
    public init(id: Int, customFields: [CustomFieldReference]? = nil, workflow: [String: String]? = nil, volume: VolumeMiniReference, fullPath: String, resolvedPermissions: [MediaRootPermission]? = nil, workflowJobs: [Job], jobs: [JobReference]? = nil, aiConfig: [String: String]? = nil, veritoneConfig: [String: String]? = nil, name: String, path: String? = nil, needsRescan: Bool? = nil, viewMode: String? = nil, viewStyle: String? = nil, viewDefaultTab: String? = nil, showTags: Bool? = nil, showComments: Bool? = nil, showLocations: Bool? = nil, showCustomFields: Bool? = nil, showRatings: Bool? = nil, showSubclips: Bool? = nil, showSubtitles: Bool? = nil, showMarkers: Bool? = nil, showHistory: Bool? = nil, showAiMetadata: Bool? = nil, prefetchThumbnailStrips: Bool? = nil, cover: String? = nil, nameField: String? = nil, shareComments: Bool? = nil, shareLinkDuration: Int? = nil, defaultProxyProfile: Int? = nil, cloudProxyProfile: Int? = nil, veritoneConnection: Int? = nil, veritoneProxyProfile: Int? = nil, aiConnection: Int? = nil, aiProxyProfile: Int? = nil, proxyProfiles: [Int]? = nil, tags: [Int]? = nil) {
        self.id = id
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encode(workflowJobs, forKey: .workflowJobs)
