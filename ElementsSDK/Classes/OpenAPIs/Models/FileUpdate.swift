...
public struct FileUpdate: Codable, JSONEncodable, Hashable {
    ...
    public init(name: String, files: [BasicFile]? = nil, parent: String, mode: String? = nil, uid: Int? = nil, gid: Int? = nil, user: String? = nil, group: String? = nil, recursive: Bool? = nil, affinity: String? = nil, modeSetuid: Bool? = nil, modeSetgid: Bool? = nil, modeSetvfx: Bool? = nil, modeUserRead: Bool? = nil, modeUserWrite: Bool? = nil, modeUserExecute: Bool? = nil, modeGroupRead: Bool? = nil, modeGroupWrite: Bool? = nil, modeGroupExecute: Bool? = nil, modeOthersRead: Bool? = nil, modeOthersWrite: Bool? = nil, modeOthersExecute: Bool? = nil) {
        self.name = name
        self.files = files
        self.parent = parent
        self.mode = mode
