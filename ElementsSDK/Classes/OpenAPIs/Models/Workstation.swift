...
public struct Workstation: Codable, JSONEncodable, Hashable {
    ...
    public init(id: String, displayName: String, rdcAllowUsers: [ElementsUserReference]? = nil, rdcAllowGroups: [ElementsGroupReference]? = nil, name: String? = nil, hostname: String, rdcLastUsed: Date? = nil, rdcDisableUpnp: Bool? = nil, rdcClientPort: Int? = nil, rdcHostPort: Int? = nil) {
        self.id = id
