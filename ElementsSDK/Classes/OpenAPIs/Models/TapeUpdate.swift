...
public struct TapeUpdate: Codable, JSONEncodable, Hashable {
    ...
    public init(name: String, uuid: String? = nil, generation: Int? = nil, customA: String? = nil, customB: String? = nil, customC: String? = nil, customD: String? = nil, freeSpace: Int? = nil, loadCounter: Int? = nil, errorCounter: Int? = nil, errorReason: String? = nil, active: Bool? = nil, lto: Lto? = nil, group: Int? = nil) {
        self.name = name
        self.uuid = uuid
