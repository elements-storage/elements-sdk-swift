...
public struct SchedulePartialUpdate: Codable, Hashable {
    ...
    public init(variables: [String: String]? = nil, type: ModelType? = nil, enabled: Bool? = nil, lastRun: Date? = nil, every: Int? = nil, period: Period? = nil, crontabDayOfMonth: String? = nil, crontabDayOfWeek: String? = nil, crontabHour: String? = nil, crontabMinute: String? = nil, crontabMonthOfYear: String? = nil, job: Int? = nil) {
