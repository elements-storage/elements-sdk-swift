...
public struct AWSAccountPartialUpdate: Codable, Hashable {
    ...
    public init(name: String? = nil, accessKeyId: String? = nil, secretAccessKey: String? = nil, endpointUrl: String? = nil, defaultRegion: DefaultRegion? = nil) {
        self.name = name
