//
// TestCloudAccountCredentialsRequest.swift
//
...
public struct TestCloudAccountCredentialsRequest: Codable, JSONEncodable, Hashable {
    ...
    public init(name: String, provider: Provider? = nil, accessId: String? = nil, secret: String? = nil, tenant: String? = nil, subscription: String? = nil, endpoint: String? = nil, mountCredentialsManagement: MountCredentialsManagement? = nil) {
        self.name = name
