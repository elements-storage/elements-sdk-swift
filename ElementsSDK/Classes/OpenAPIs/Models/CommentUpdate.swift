...
public struct CommentUpdate: Codable, JSONEncodable, Hashable {
    ...
    public init(assignee: AnyOfElementsUserMiniReferenceAnyType? = nil, user: AnyOfElementsUserMiniReferenceAnyType? = nil, drawing: [String: String]? = nil, tags: [TagReference]? = nil, text: String? = nil, time: Double? = nil, isCloud: Bool? = nil, resolved: Bool? = nil, resolvedDate: Date? = nil, asset: Int, root: Int? = nil, parent: Int? = nil) {
