...
public struct VolumeUpdate: Codable, JSONEncodable, Hashable {
    ...
    public init(path: String? = nil, nodes: [Int], displayName: String? = nil, visualTag: String? = nil, isDefault: Bool? = nil, useForHomes: Bool? = nil, useForWorkspaces: Bool? = nil, type: ModelType? = nil, snmEnabled: Bool? = nil, snfsName: String? = nil, simulatedQuotas: Bool? = nil, cloudAccount: Int? = nil) {
        self.path = path
        self.nodes = nodes
